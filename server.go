...
func main() {
	...
	{
		authorizedEndpoints.Post("team/:team_id/account", apis.PostAccount)
		authorizedEndpoints.Post("team/:team_id/account", apis.PostAccount)
		authorizedEndpoints.Post("team/:team_id/account/:account_id/event", apis.PostEvent)
		authorizedEndpoints.Post("team", apis.PostTeam)
		authorizedEndpoints.Post("team/:team_id/image", apis.PostImage)
		authorizedEndpoints.Get("team/:team_id/account", apis.GetAccount)
